...
class Sm_Pagebuilder_Block_Adminhtml_Widget_Form_Renderer_Fieldset_Addwidget extends Mage_Adminhtml_Block_Template implements Varien_Data_Form_Element_Renderer_Interface {
    protected $_element;
