...
class Sm_Pagebuilder_Adminhtml_Pagebuilder_PagebuilderController extends Mage_Adminhtml_Controller_Action
{
	...
	{
		$this->loadLayout()
			->_setActiveMenu('adminhtml/pagebuilder_managepagebuilder')
			->_addBreadcrumb(Mage::helper('adminhtml')->__('Pagebuilder Manager'), Mage::helper('adminhtml')->__('Pagebuilder Manager'));
...
//	}
	...
	public function exportCsvAction(){
		$fileName   = 'pagebuilder.csv';
		$content    = $this->getLayout()
			->createBlock('pagebuilder/adminhtml_pagebuilder_grid')
			->getCsvFile();
		$this->_prepareDownloadResponse($fileName, $content);
	}

	public function exportExcelAction(){
		$fileName   = 'pagebuilder.xls';
		$content    = $this->getLayout()
			->createBlock('pagebuilder/adminhtml_pagebuilder_grid')
			->getExcelFile();
		$this->_prepareDownloadResponse($fileName, $content);
	...
	public function loadIndexAction() {
        ...
        $block = $this->getLayout()->createBlock('pagebuilder/adminhtml_pagebuilder_widget', 'adminhtml_pagebuilder_widget');
